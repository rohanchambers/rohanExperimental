...
function _scripts() {
	...
	// Register styles.
	wp_register_style( 'wdunderscores-google-font', _font_url(), array(), null );
	...
	// Enqueue scripts.
	wp_enqueue_script( 'wdunderscores-scripts', get_template_directory_uri() . '/assets/scripts/project' . $suffix . '.js', array( 'jquery' ), $version, true );
	...
	wp_enqueue_script( 'wdunderscores-mobile-nav', get_template_directory_uri() . '/assets/scripts/mobile-nav-menu' . $suffix . '.js', array( 'jquery' ), $version, true );
}
