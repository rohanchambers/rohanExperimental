...
<head>
    ...
    <title>Phone Req | iPod repair</title>
        ...
        <div class="row row-intro">
            <header>
                <article class="intro">
                    ...
                    <p>For our customers with iPods, we offer screen replacements, LCD display repair, back covers, and headphone jacks. We can work with any iPod model; from the new iPod Touch to the classics.</p>
                </article>
            </header>
        </div>
                ...
                <form id="filter-model">
                    <div>
                        <select class="filter-model btn-animate">
                            ...
                            <option value="ipodTouch">iPod Touch 4th gen. / 5th gen.</option>
                            <option value="ipodNano">iPod Nano</option>
                            <option value="ipodClassic">iPod Classic</option>
                        </select>
