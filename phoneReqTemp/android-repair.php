...
<head>
    ...
    <title>Phone Req | Android repair</title>
...
<section id="repair">
    <div class="container">
        ...
        <div class="row row-intro">
            <header>
                <article class="intro">
                    <h1>Android repair<span></span></h1>
                    <p>Samsung, LG, HTC and many more brand devices fall under the Android category. If you're unsure of whether we cover your model, just let us know and we'll be able to tell you whether or not we can help. Our skills cover a wide range of Android-based devices.</p>
                    <p>Considering there are so many varieties of Android devices, we can't list all of our pricing models for each device. Send us a message through our <a href="#contact">contact us form</a> and we'll give you a quote in no time at all. You can also call us during normal business operating hours or stop by our store at <a href="#contact">store address</a> for more information.</p>
                    <p>Galaxy Edge series including notes and S series - please contact us for quote. If you don't see your model listed - please contact us for quotes and availability.</p>
                </article>
            </header>
        </div>
